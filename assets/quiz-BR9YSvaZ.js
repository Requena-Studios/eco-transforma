import{v as O,a as y,b as L}from"./index-BU9KMsL8.js";const m=10,T=new URL("/eco-transforma/data/quiz-questions.json",window.location.origin).toString();function z(e){const t=e.slice();for(let s=t.length-1;s>0;s--){const r=Math.floor(Math.random()*(s+1));[t[s],t[r]]=[t[r],t[s]]}return t}function b(e,t){return z(e).slice(0,t)}function x(e,t){const s=new Set,r=[];for(const c of e){const o=t(c);s.has(o)||(s.add(o),r.push(c))}return r}function R(e){const s=z([0,1,2]),r=s.map(o=>e.options[o]),c=s.indexOf(0);return{q:e.q,options:r,answer:c}}const M={async mount(e){e.innerHTML=`
